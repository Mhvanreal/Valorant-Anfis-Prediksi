...
@section('content')
    ...
    <div class="mb-6">
        <div class="flex items-center mb-3 space-x-2 text-sm text-gray-600 dark:text-gray-400">
            ...
            <span class="font-medium text-gray-900 dark:text-white">Tambah Skin</span>
        </div>
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Skin Baru</h1>
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Tambahkan skin berdasarkan weapon yang dipilih</p>
    </div>

    <!-- Form Card -->
    <div class="max-w-2xl">
        <div class="bg-white rounded-lg shadow-md dark:bg-gray-800">
            <form action="{{ route('skins.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                        ...
                        Pilih weapon untuk skin ini (misal: Vandal, Phantom, dll)
                    </p>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="skin_name" id="skin_name" value="{{ old('skin_name') }}"
                ...
                <div>
                    ...
                    <select name="rarity" id="rarity"
                        ...
                        <option value="Premium" {{ old('rarity') == 'Premium' ? 'selected' : '' }}>Premium</option>
                        <option value="Exclusive" {{ old('rarity') == 'Exclusive' ? 'selected' : '' }}>Exclusive</option>
                        <option value="Ultra" {{ old('rarity') == 'Ultra' ? 'selected' : '' }}>Ultra</option>
                        <option value="Deluxe" {{ old('rarity') == 'Deluxe' ? 'selected' : '' }}>Deluxe</option>
                    </select>
                    @error('rarity')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                        ...
                        Masukkan harga dalam Valorant Points (VP)
                    </p>
                </div>
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-4">
                        <input type="range" name="vfx" id="vfx_range"
                    ...
                    <input type="hidden" name="vfx" id="vfx" value="{{ old('vfx', 5) }}">
                    @error('vfx')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                    <div class="flex justify-between mt-1 text-xs text-gray-500 dark:text-gray-400">
                        ...
                        <span class="font-medium text-red-600 dark:text-red-400">
                            Nilai: <span id="vfx_display">{{ old('vfx', 5) }}</span>/10
                        </span>
                ...
                <div>
                    ...
                    <div id="url_input_container" class="hidden">
                        <input type="url" name="image_url" id="image_url" value="{{ old('image_url') }}"
                            ...
                            onchange="previewImage(event, 'url')">
                        @error('image_url')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
